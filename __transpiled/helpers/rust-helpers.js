...
function toRustIdentifier(str) {
  ...
  let identifier = str.replace(/[^a-zA-Z0-9_]/g, '_').replace(/^[0-9]/, '_$&') // Prefix numbers with underscore
...
function getRustType(schema) {
  ...
  switch (type) {
    ...
    // For now, use generic JSON value
    default:
      return 'serde_json::Value';
  }
}
...
//# sourceMappingURL=rust-helpers.js.map
